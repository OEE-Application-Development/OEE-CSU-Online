...
call sf org create scratch -a OEE-CSU-Online__dev -f orgs/dev.json -w 10

REM Set newly created scratch org as default org.
call sf config set target-org OEE-CSU-Online__dev

REM Import newly created org into CCI for setup commands.
start "CCI Import" /wait /b cci org import OEE-CSU-Online__dev dev
